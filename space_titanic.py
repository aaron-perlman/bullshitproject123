...
class TitanicModel:
    ...
    def download_dataset(self) -> None:
        ...
        self.api.competition_download_files(self.competition_name, str(self.download_path))
    ...
    def load_data(self) -> None:
        ...
        TODO: First, checks to see if train.csv exists in the path used by download_dataset.
        ...
        """
        # COMPLETED TODO
        if not (self.download_path / "train.csv").exists():
            self.download_dataset()
        self.train_data = pd.read_csv(self.download_path / "train.csv")
        self.test_data = pd.read_csv(self.download_path / "test.csv")
    ...
    def train_model(self, X_train: pd.DataFrame, y_train: pd.Series, X_val: pd.DataFrame, y_val: pd.Series) -> None:
        ...
        for n_neighbors in tqdm(range(1, 51), desc="Tuning k-NN Hyperparameters"):  
            ...
            # Train KNN model
            # TODO: figure out what .fit takes as arguments
            # COMPLETED TODO
            model.fit(X_train, y_train)
            
            # Calculate accuracy on validation data
            # TODO: figure out what accuracy_score takes as arguments
            ...
            if score > self.best_score:
                # TODO: assign model to best_model instance variable
                # TODO: assign score to best_score instance variable
                # COMPLETED TODO
                self.best_model = model
                self.best_score = score

        # TODO: add  best_model and best_score instance variables to print
        # COMPLETED TODO
        print(f"Best model (k = {self.best_model.n_neighbors}) achieved validation accuracy: {self.best_score:.4f}\n")
    ...
    def visualize_data(data: pd.DataFrame) -> None:
        ...
        # TODO: create bar graph of size 12, 8
    ...
    def visualize_correlation(data: pd.DataFrame) -> None:
        ...
        # TODO: Plot the correlation in a 10, 10 figure
    ...
    def run(self) -> None:
        ...
        # TODO: identify and include most relevant features to train on
        #       full list of features is provided in Step 6.

        # A simple reasonable choice: drop text-like fields (Cabin, Name) and ID
        # COMPLETED TODO (you can modify this list later as desired)
        selected_features = [
